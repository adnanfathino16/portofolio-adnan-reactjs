      ...
      <div className="container" data-aos="fade-down" data-aos-delay="500">
        <div className="w-full px-4">
          <div className="mx-auto mb-16 max-w-xl text-center">
            ...
            <p className="text-md font-medium text-secondary md:text-lg">Kirim saya sebuah pesan jika ada yang ingin disampaikan. Terima kasih</p>
          </div>
        </div>
        <form>
          <div className="w-full lg:mx-auto lg:w-2/3">
            ...
            <div className="mb-8 w-full px-4">
              <label htmlFor="pesan" className="text-base font-bold text-primary">
                Pesan
              </label>
              <textarea type="text" id="pesan" className="h-32 w-full rounded-md bg-slate-200 p-3 text-dark focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary"></textarea>
            </div>
            <div className="w-full px-4">
